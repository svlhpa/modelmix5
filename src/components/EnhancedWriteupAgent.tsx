...
import { X, FileText, Brain, CheckCircle, AlertCircle, Clock, Play, Pause, Download, Eye, Edit, RotateCcw, Zap, Target, Users, Shield, DollarSign, BookOpen, FileCheck, Layers, Globe, ChevronDown, ChevronUp, Bot, Crown, Network } from 'lucide-react';
